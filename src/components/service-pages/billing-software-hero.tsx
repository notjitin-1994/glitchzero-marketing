...
export function BillingSoftwareHero() {
  return (
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-24 px-6 bg-carbon text-center">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="typo-subhead text-lg text-tungsten max-w-3xl mx-auto mt-8 leading-relaxed">
          Replace clunky spreadsheets and expensive subscriptions with simple, powerful billing software designed for your exact business needs. We rapidly build and deploy custom solutions for desktop that streamline your invoicing and payments.
        </p>
      </div>
    </section>
  );
