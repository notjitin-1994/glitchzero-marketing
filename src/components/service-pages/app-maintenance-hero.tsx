...
export function AppMaintenanceHero() {
  return (
    <section className="relative pt-28 pb-8 md:pt-28 md:pb-10 px-6 bg-carbon overflow-hidden">
        ...
        <ContrastWrapper className="space-y-6 z-10">
          ...
          <FadeInSection delay={0.2} direction="up">
            <h1 className="typo-headline text-5xl md:text-7xl leading-tight text-platinum">
              <ContrastText as="span" variant="monochrome">Website & App Maintenance,</ContrastText>
