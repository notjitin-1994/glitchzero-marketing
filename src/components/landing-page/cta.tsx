  ...
  return (
    <section className="py-32 px-6 text-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        <h2 className="typo-headline text-4xl md:text-5xl text-platinum mb-8">Ready to grow your business?</h2>
        <p className="typo-body text-tungsten text-lg mb-10 max-w-xl mx-auto">
          Don't let technology hold you back. Let's build a digital presence that brings you more customers and more profit.
        </p>
